      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div {...fadeUp} className="text-center mb-16">
          ...
          <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-snug max-w-4xl mx-auto">
            ...
            <span className="text-accent-sky">blind asset</span>. No SOH
          ...
          <p className="mt-6 text-lg md:text-xl text-brand-200 max-w-2xl mx-auto">
            ...
            <span className="font-bold text-accent-sky">8&ndash;12%</span> &mdash;
        ...
        >
          {stats.map((stat) => (
            ...
            >
              <stat.icon className="h-8 w-8 text-accent-sky mx-auto mb-3" />
