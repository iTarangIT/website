...
def _state(proposals: list[dict], blogs: list[dict], social: list[dict] | None = None) -> dict:
    return {
        ...
        "analytics": {
            ...
            "search_console": {},
            "ga4": {"status": "none"},
            "ga4_audience": {"status": "none", "traffic_sources": [],
                             "previous_traffic_sources": [], "devices": [], "browsers": [],
                             "landing_pages": []},
            "ga4_geography": {"status": "none", "countries": [], "country_sources": [],
                              "country_channels": []},
            "pages": [],
            "insights": [],
            "summary": {"what": [], "why": [], "actions": [], "caveats": []},
            "campaigns": {"rows": [], "unavailable": [], "unavailable_reason": ""},
